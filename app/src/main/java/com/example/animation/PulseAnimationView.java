...
public class PulseAnimationView extends View {
    ...
    private AnimatorSet mPulseAnimationSet = new AnimatorSet();
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if(mPulseAnimationSet != null && mPulseAnimationSet.isRunning()){
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mPulseAnimationSet.play(repeatAnimator).before(shrinkAnimator);
